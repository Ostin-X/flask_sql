...
# res = requests.get('http://127.0.0.1:5000/api/v1/courses?course_name=math')

# res = requests.post('http://127.0.0.1:5000/api/v1/students', json={'first_name': 'Liolyk', 'last_name': 'Roundabout'})
res = requests.put('http://127.0.0.1:5000/api/v1/students/335', json={'course_add': 1})
# res = requests.put('http://127.0.0.1:5000/api/v1/students/15', json={'course_remove': 1})
