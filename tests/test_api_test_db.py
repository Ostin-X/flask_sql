...
@pytest.mark.parametrize('test_student_input,test_course_input, res_code, res_text', [(7, 0, 200,
                                                                                       b'{"data": {"id": 7, "first_name": "Student_3", "last_name": "Student_3", "courses": [0]}}\n'),
                                                                                      (7, 1, 200,
                                                                                       b'{"data": {"id": 7, "first_name": "Student_3", "last_name": "Student_3", "courses": [0, 1]}}\n'),
                                                                                      (7, 1, 400,
